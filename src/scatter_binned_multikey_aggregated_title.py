...
def create_scatter_plots(input_filename, keys, title, xaxis, yaxis, xbins, xlo, xhi, ybins, ylo, yhi):
    ...
    x_values = values['x']
    y_values = values['y']
    plt.scatter(x_values, y_values, label=f'Data Points')
    plt.xlim(xlo,xhi)
    plt.ylim(ylo,yhi)
...
if __name__ == "__main__":
    ...
    create_scatter_plots(input_filename, keys, title, xaxis, yaxis, xbins, xlo, xhi, ybins, ylo, yhi)
